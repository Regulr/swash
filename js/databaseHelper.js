var databaseHelper = (function () {
  ...
  async function initJsStore() {
    ...
    console.warn('isDbCreated', isDbCreated);
    if (isDbCreated) {
  ...
  async function getTotalMessageCount() {
    ...
    console.warn('getTotalMessageCount rows: ', rows);
  ...
  function insertMessage(message) {
    ...
    return connection
      ...
      .then(function (rowsInserted) {
        console.warn('rowsInserted: ', rowsInserted);
      })
      .catch(function (err) {
        console.error(err);
      });
  ...
  async function getReadyMessages(time) {
    ...
    console.warn('getReadyMessages: ', rows);
    return rows;
  }
